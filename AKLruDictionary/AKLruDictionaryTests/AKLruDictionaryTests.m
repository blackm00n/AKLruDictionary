...
-(void)test
{
    AKLruDictionary* lruDictionary = [[AKLruDictionary alloc] initWithCountLimit:3
                                                              perObjectCostLimit:10
                                                                       costLimit:9];
    [lruDictionary setObject:@(1) forKey:@"1" cost:1]; // 1
    [lruDictionary setObject:@(2) forKey:@"2" cost:2]; // 2, 1
    [lruDictionary setObject:@(3) forKey:@"3" cost:3]; // 3, 2, 1
    [lruDictionary setObject:@(4) forKey:@"4" cost:4]; // 4, 3, 2
    ...
    [lruDictionary setObject:@(5) forKey:@"5" cost:5]; // 5, 4
    ...
    [lruDictionary setObject:@(10) forKey:@"10" cost:10]; // 9
    ...
    [lruDictionary setObject:@(4) forKey:@"4" cost:4]; // 4, 3, 1
